...
"""
This is a program for the CKY Recognizer. It reads the grammar 
from "atis-grammar-cnf.cfg" which is already in CNF, and uses it to 
recognize the test sentences in the "atis-test-sentences.txt" file.

The output of this program is another file, "recognizer_output.txt"   
...
with open("../data/atis-test-sentences.txt", "r", encoding="utf-8") as test_file:
    with open("recognizer_output.txt", "w", encoding="utf-8") as file_output:
